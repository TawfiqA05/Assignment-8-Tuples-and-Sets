Write a function that makes lists of states that have “totalTestResults” above a certain level for each month of the dataset and writes it to a new CSV file.


make sure that it is generalzed to the whole data set provided and that no external libraries are used

use file_path = "/Users/tawfiqabulail/Downloads/Information Infrastructure I /covid_data_set.csv"
